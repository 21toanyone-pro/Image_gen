...
def encode_utf8_string(text, length, dic, null_char_id=2445):
...
dict={}
with open('kor_datasets.txt', encoding="utf") as dict_file:
...
tfrecord_writer  = tf.python_io.TFRecordWriter("eval") 
